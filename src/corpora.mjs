...
export const CORPUS_CATALOG = Object.freeze({
  'oewn-2025': source({
    ...
    ingestionStatus: 'probe-complete-adapter-pending',
    nextArtifact: 'sense-aware-shard-prototype',
  }),
  ...
  'atomic-2020': source({
    ...
    ingestionStatus: 'license-and-download-snapshot-pending',
  }),
...
export async function corpusStatus(id) {
  ...
  return {
    ...
    architectureGate: generatedModel ? 'passed-by-sharded-generated-model' : definition.architectureGate,
    nextArtifact: generatedModel ? 'held-out-and-randomized-evaluation' : probeComplete ? 'sense-aware-shard-prototype' : definition.nextArtifact,
    sourceCached,
    probeComplete,
