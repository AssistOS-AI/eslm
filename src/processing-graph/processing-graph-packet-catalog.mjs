...
const PACKET_SEMANTICS = [
  ...
  packet('runtime:runtime-result',
    ...
    ['approximation', 'capabilityGap', 'grounding', 'input', 'knowledgeDiagnostics',
      'knowledgeContext', 'languageAssessment', 'learned', 'learnedRules', 'normalization', 'plan',
      'profile', 'provenance', 'query', 'reasoning', 'requestPlanning', 'synthesis', 'taskFrame',
      'values', 'workPolicy'],
  ...
  packet('runtime:task-knowledge-context',
    ['format', 'status', 'questionAnalysis', 'selfQuestionPlan', 'focus', 'search', 'entries',
      'selectedKbVersions', 'consultedKbVersions', 'completeness'],
    ['realization'], 'No bounded query-local context record was found or context construction was disabled.',
    ['tokens', 'candidates', 'lookups', 'evidence-items', 'output-bytes'], {
      provenance: 'conditional', validationOwner: 'node:runtime:task-context-coordinator',
    }),
