...
const BENCHMARKS = {
  blimp: { title: 'BLiMP', page: 'benchmarks/benchmark-blimp.html' },
  babi: { title: 'bAbI', page: 'benchmarks/benchmark-babi.html' },
  clutrr: { title: 'CLUTRR', page: 'benchmarks/benchmark-clutrr.html' },
  ewok: { title: 'EWoK', page: 'benchmarks/benchmark-ewok.html' },
  simpleqa: { title: 'SimpleQA', page: 'benchmarks/benchmark-simpleqa.html' },
  entityTracking: { title: 'Entity Tracking', page: 'benchmarks/benchmark-entity-tracking.html' },
  storyCloze: { title: 'Story Cloze', page: 'benchmarks/benchmark-story-cloze.html' },
  logicbench: { title: 'LogicBench', page: 'benchmarks/benchmark-logicbench.html' },
  iibench: { title: 'IIBench', page: 'benchmarks/benchmark-iibench.html' },
  proofwriter: { title: 'ProofWriter', page: 'benchmarks/benchmark-proofwriter.html' },
  prontoqa: { title: 'PrOntoQA', page: 'benchmarks/benchmark-prontoqa.html' },
  folio: { title: 'FOLIO', page: 'benchmarks/benchmark-folio.html' },
  'slr-bench': { title: 'SLR-Bench', page: 'benchmarks/benchmark-slr-bench.html' },
  logicskills: { title: 'LogicSkills', page: 'benchmarks/benchmark-logicskills.html' },
  proverqa: { title: 'ProverQA', page: 'benchmarks/benchmark-proverqa.html' },
  stepgame: { title: 'StepGame', page: 'benchmarks/benchmark-stepgame.html' },
  'sparc-sparp': { title: 'SpaRC / SpaRP', page: 'benchmarks/benchmark-sparp.html' },
  satbench: { title: 'SATBench', page: 'benchmarks/benchmark-satbench.html' },
  zebralogic: { title: 'ZebraLogic', page: 'benchmarks/benchmark-zebralogic.html' },
  'defeasible-nli': { title: 'Defeasible NLI', page: 'benchmarks/benchmark-defeasible-nli.html' },
  'alpha-nli-art': { title: 'αNLI / ART', page: 'benchmarks/benchmark-alpha-nli-art.html' },
  reclor: { title: 'ReClor', page: 'benchmarks/benchmark-reclor.html' },
  logiqa: { title: 'LogiQA', page: 'benchmarks/benchmark-logiqa.html' },
};
