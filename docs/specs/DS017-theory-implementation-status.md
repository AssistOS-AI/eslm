...
| Evaluation and reports | Node test, evaluation, public benchmark, seeded conversational benchmark, interactive smoke execution, diversity gates, and HTML publishing modules | Task 15 and Task 16 public results, 204 short cases across 174 structural forms, and 1,000 long cases across 536 forms | conversational suite is internal/source-exposed and cannot establish open-English competence |
